...
###############################################################################
def processAll(i, writer, skus, features, segments, seg_features, seg_ids, categories, categories_features_lookup, classes, classes_features_lookup, subclasses, subclasses_features_lookup, manufacturers, mfrPartNums):
        #if i == 3:
        #    break
